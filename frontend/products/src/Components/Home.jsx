    ...
    <div className="relative w-full">
      ...
      >
        ...
        <div className="relative z-20 px-6 w-full max-w-7xl mx-auto flex flex-col items-center justify-center text-center">
          ...
          {/* Paragraphs + Button */}
          <div
            className="w-full md:w-2/3 lg:w-1/2 text-gray-200 text-sm md:text-lg leading-relaxed text-center"
      ...
      {/* Recognized Text */}
      <div className="mt-12 mb-8 text-center text-black text-3xl font-semibold" style={{ fontFamily: `'Roboto', sans-serif` }}>
        Recognized By
      </div>

      {/* Logos Section */}
      <div className="py-2 flex justify-center items-center gap-2">
<img src="/logos/1.png" alt="Logo 1" className="h-24 sm:h-32 md:h-40 w-auto object-contain" />
<img src="/logos/2.png" alt="Logo 1" className="h-24 sm:h-32 md:h-40 w-auto object-contain" />
<img src="/logos/3.png" alt="Logo 1" className="h-24 sm:h-32 md:h-40 w-auto object-contain" />
      </div>
    </div>
  );
};
